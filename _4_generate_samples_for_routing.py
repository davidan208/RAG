...
json_file = glob.glob(json_dir + "/*.json")[
    0
]  # Only one json file is allowed to be existed

with open("json_src/test.json", "r") as file:
    data = json.load(file)
...
related_questions = related_chain.invoke({"content": content})
